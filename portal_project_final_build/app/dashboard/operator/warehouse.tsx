...
import type { Map as MapLibreMap, MapMouseEvent, LngLatBoundsLike, ExpressionSpecification, StyleSpecification } from 'maplibre-gl';
...
export default function WarehouseMapPage() {
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (zone && mapRef.current) {
      ...
      let coords: any[] = geom.type === 'Polygon' ? geom.coordinates[0] : geom.coordinates[0][0];
      const bounds = coords.reduce((b: maplibregl.LngLatBounds, coord: [number, number]) => b.extend(coord), new maplibregl.LngLatBounds(coords[0], coords[0]));
